...
class _ProjectsManagerScreenState extends State<ProjectsManagerScreen> {
  ...
  Future<void> loadParticipants(int projectId) async {
    final response = await supabase
        ...
        .select('''*, practicantes(id, names, fathers_surname, mothers_surname)''').eq(
  ...
  Future<void> loadInterns() async {
    final response =
        await supabase.from('practicantes').select().order('names');
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, index) {
                            ...
                            final isSelected =
                                selectedMembersIds.contains(internId);
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField<int>(
                        ...
                        onChanged: (value) =>
                            setModalState(() => selectedLeaderId = value),
                      ),
                    ),
                    const SizedBox(height: 16),
                    SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _infoGrid([
                ...
                _InfoItem(Icons.email_rounded, 'Correo',
                    intern['institutional_email']),
                _InfoItem(Icons.calendar_today_rounded, 'Inicio',
  ...
  Future<void> showUsersForm(
      {Map<String, dynamic>? project, bool isEdit = false}) async {
            ...
            return CustomAlertDialog(
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    _styledField(
                        'Título', titleController, Icons.title_rounded),
                    const SizedBox(height: 12),
                    _styledField('URL de imagen', imageUrlController,
                        Icons.image_rounded),
                    const SizedBox(height: 12),
                    _styledField('Descripción', descriptionController,
  ...
  Widget _styledField(String label, TextEditingController ctrl, IconData icon,
      {int maxLines = 1}) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text('Aún no hay proyectos',
                    ...
                    children: [
                      ...
                      FutureBuilder<List<Map<String, dynamic>>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Row(
                            children: [
                              ...leader.map((p) => participantAvatar(
                                  intern: p['practicantes'],
                                  color: _leaderColor,
                                  role: 'Líder',
                                  size: 30)),
                              ...members.map((p) => participantAvatar(
                                  intern: p['practicantes'],
                                  color: _memberColor,
                                  role: 'Integrante',
                                  size: 30)),
    ...
    return Container(
      ...
      child: Center(
        child: Icon(Icons.folder_special_rounded,
            size: 48, color: _primary.withValues(alpha: 0.25)),
      ),
    );
  }
                  ...
                  children: [
                    ...
                    FutureBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final participants = snapshot.data!;
                        final leader = participants
                            .where((e) => e['role'] == 'Líder')
                            .toList();
                        final members = participants
                            .where((e) => e['role'] == 'Integrante')
                            .toList();
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
