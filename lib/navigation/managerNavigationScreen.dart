        ...
        body: Row(
          children: [
            SidebarX(
              ...
              items: [
                const SidebarXItem(icon: Icons.bar_chart, label: 'Proyectos'),
                const SidebarXItem(icon: Icons.groups, label: 'Practicantes'),
                const SidebarXItem(icon: Icons.chat, label: 'Comunicados'),
                SidebarXItem(
